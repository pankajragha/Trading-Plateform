      ...
      <footer className='border-top' style={{backgroundColor:"rgb(250,250,250)"}}>
        <div className='container mt-5'> 
         <div className='row mt-5'>
          <div className='col'>
            <img src='media/images/StockTradingPlateform.png' style={{width:"30%"}}/>
            <p className='mt-3'>
              &copy; 2010 - 2025, Stock Trading Plateform Broking Ltd.<br></br>
...
All rights reserved.
          ...
          <div className='col'>
            <p>Company</p>
             ...
             <a href='' style={{textDecoration:"none"}}>ST Cares (CSR)</a>
          </div>
          <div className='col'>
            <p>Support</p>
         ...
         <p >
         Stock Trading Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: Stock Trading Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@ST.com, for DP related to dp@ST.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
...
<p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Stock Trading Plateorm and offering such services, please create a ticket here.</p>
<div className='text-center'>
<a href='' style={{textDecoration:"none"}}>NSE</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='' style={{textDecoration:"none"}}>BSE</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='' style={{textDecoration:"none"}}>MCX</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href='' style={{textDecoration:"none"}}>Terms & Condition</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
